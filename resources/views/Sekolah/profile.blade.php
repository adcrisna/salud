            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <form action="{{ route('sekolah.updateProfile') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <input type="number" name="telepon" class="form-control" value="{{ $sekolah->telepon }}"
                                    required>
                            </div>
                            <div class="form-group has-feedback">
                                <label>Alamat :</label>
                                <textarea name="alamat" id="alamat" class="form-control" cols="10" rows="5">{{ $sekolah->alamat }}</textarea>
                            </div>
                            <div class="form-group has-feedback">
                                <img class="zoom" width="30%" heigh="30%"
                                    src="{{ asset('logo/' . @$sekolah->logo) }}">
                            </div>
                            <div class="form-group has-feedback">
